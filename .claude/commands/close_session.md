...
## Шаг 6. Закоммитить handoff через docs-PR и смержить по зелёному CI
...
gh pr create --body-file <файл>
gh pr checks <PR> --watch && gh pr merge --squash --delete-branch
